...
11. Customize template - Complete the following:
    1. In **NIC 1 (eth0) IPv4 address** type **192.168.100.12** or **192.168.200.12**, depending on your student workshop number.
    2. **DNS server address** type **192.168.100.10** or **192.168.200.10**, depending on your student workshop number.
    3. **NIC 1 (eth0) netmask** type **255.255.255.0**
    4. **IPv4 Default Gateway** type **192.168.100.1** or **192.168.200.1**, depending on your student workshop number.
    5. **Unified Gateway Appliance Nmae** type **UAG100** or **UAG200**, depending on your student workshop number.
    6. **Join CEIP** Untick the checkbox, under text.
    7. **Password for the root user and the Admin User** type **VMware1!**
